...
class Order(models.Model):
    ...
    # Legacy IntaSend fields (kept for historical orders)
    ...
    # WooCommerce mirror fields (populated by the Woo webhook receiver)
    woo_order_id              = models.PositiveIntegerField(null=True, blank=True, unique=True)
    woo_status                = models.CharField(max_length=30, blank=True)
    woo_payment_gateway       = models.CharField(max_length=50, blank=True)
